...
export const FormRig = () => {
  ...
  const form = useForm<any>({
    defaultValues: {
      ...
      air_gap: 20,
      stand_length: 90,
      equipment_type: 'Riser' as 'Riser' | 'BOP' | 'MPD',
      pumps: [
        {
          type: 'Triplex',
          linear_diameter: 6.0,
          stroke_diameter: 12.0,
          rod_diameter: 0,
          efficiency: 97.0,
        },
      ],
                    ...
                    <tr>
                      <td className='plabs-caption-regular-12 text-greyscale-7 px-3 py-2 text-sm'>
                        ...
                        >
                          ...
                          disabled <Icons.Plus className='text-greyscale-0 h-3 w-3' />
                        </button>
                      </td>
                    </tr>
                  </tbody>
                      ...
                      <tr key={field.id} className={index % 2 === 0 ? 'bg-greyscale-7' : 'bg-greyscale-8'}>
                        ...
                        <td className='plabs-caption-regular-12 text-greyscale-7 px-3 py-4 text-sm'>
                          {fields_rig_pressure_loss.length > 1 && (
                            ...
                            >
                              disabled <Icons.Trash className='text-red-base size-4' />
                            </button>
                          )}
                        </td>
                      </tr>
